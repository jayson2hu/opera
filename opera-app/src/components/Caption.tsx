...
export default function Caption({ text, onChange, onBeforeChange, onCustomEdit, tone = 'primary', disabled }: CaptionProps) {
  return <section className="animate-slide-up">
    ...
    {onChange ? <BodyEditor value={text} onChange={onChange} onBeforeChange={onBeforeChange}
